          ...
          <section id="productList">
            ...
            <div className="productList">
              ...
              <div>
                ...
                <h3>Business</h3>
                <p>
                  A website for your business with maximum implementation of
                  your needs.
                </p>
              </div>
              <div>
              ...
              <div>
                ...
                <h3>Blog</h3>
                <p>
                  Want to share your thoughts? No problem, we will create a
                  blog!
                </p>
              </div>
              <div>
              ...
              <div>
                ...
                <h3>Optimization</h3>
                <p>
                  Your site will be optimized as much as possible for search
                  engines
                </p>
              </div>
            </div>
          ...
          <section id="about">
            ...
            <div className="about">
              <div className="block">
                ...
                <p>
                  {" "}
                  We are a team of professionals focused on the maximum result
                  for the client. We strive to create not just impressive, but
                  the most useful and effective things. We work for results,
              ...
              <div className="block">
                ...
                <h1>Communication</h1>
                <p>
                  We are fully open to any client's needs. Communication with
                  the client takes place at all stages of development to achieve
                  the maximum result. The motto of our company is a satisfied
                  client, we are satisfied.
                </p>
              </div>
            </div>
